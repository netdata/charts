...
- `src/chartLibraries/gpu/`: backend-neutral exact line/Area visualizations, payload/range indexing, axes, overlays, interactions, color, and text shaping.
