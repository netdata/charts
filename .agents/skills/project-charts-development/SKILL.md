...
- `src/chartLibraries/gpu/`: backend-neutral exact Line/Area/Stacked visualizations, payload/range indexing, axes, overlays, interactions, color, and text shaping.
