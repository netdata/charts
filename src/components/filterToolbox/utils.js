...
export const getStats = (
  ...
  return {
    ...
    min: chart.getConvertedValue(getValueOrZero(obj.sts, "min")),
    avg: chart.getConvertedValue(getValueOrZero(obj.sts, "avg")),
    max: chart.getConvertedValue(getValueOrZero(obj.sts, "max")),
