import { getPathname, errorCodesToMessage } from "./api"
...
export default (chart, sdk) => {
  ...
  let channel = sdk.rtcConnection.createDataChannel(chart.getAttribute("contextScope").join("|"))
  ...
  chart.fetch = () => {
    ...
    if (channel.readyState !== "open") {
      console.warn("not ready", getPathname(chart))
      return
    }
    console.log(getPathname(chart))
    channel.send(getPathname(chart))
    // return chart
