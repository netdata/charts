...
;(function (root, factory) {
  ...
  var labels = {
    ...
    add: function (pie, section, sectionDisplayType) {
      ...
      var labelGroup = (pie.__labels[section] = outerLabel
      ...
      if (include.mainLabel) {
        labelGroup
          ...
          .style("fill", function (d, i) {
            return settings.mainLabel.color === "segment"
    ...
    computeLabelLinePositions: function (pie) {
      pie.lineCoordGroups = []
      pie.__labels.outer.each(function (d, i) {
    ...
    addLabelLines: function (pie) {
      ...
      lineGroup
        ...
        .style("opacity", function (d, i) {
          ...
          var isHidden =
            (percentage !== null && d.percentage < percentage) ||
...
*/
    ...
    maybeCloseOpenSegment: function (pie) {
      if (
        ...
        pie.svg.selectAll("." + pie.cssPrefix + "expanded").size() > 0
      ) {
  ...
  var text = {
    ...
    positionTitle: function (pie) {
      ...
      pie.__title.attr("x", x).attr("y", y)
    },

    addSubtitle: function (pie) {
      var headerLocation = pie.options.header.location

      pie.__subtitle = pie.svg
    ...
    positionSubtitle: function (pie) {
      ...
      pie.__subtitle.attr("x", x).attr("y", y)
    },

    addFooter: function (pie) {
      pie.__footer = pie.svg
    ...
    positionFooter: function (pie) {
      ...
      pie.__footer.attr("x", x).attr("y", canvasHeight - canvasPadding.bottom)
    },
  ...
  var tt = {
    addTooltips: function (pie) {
      ...
      tooltips
        ...
        .style("font-weight", function (d) {
          return pie.options.tooltips.styles.fontWeight
        })
        .style("font-family", function (d) {
    ...
    hideTooltip: function (pie, index) {
      ...
      d3.select("#" + pie.cssPrefix + "tooltip" + tt.currentTooltip).attr(
        "transform",
        function (d, i) {
